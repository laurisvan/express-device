...
function DeviceParser(req) {
    ...
    self.get_type = function() {
    	...
    	else if (ua.match(/Bot|Crawler|Spider|Web Preview|Yahoo|ia_archiver|Covario-IDS|findlinks|DataparkSearch|larbin|Mediapartners-Google|NG-Search|Snappy|Teoma|Jeeves|TinEye|facebookexternalhit/i) && !ua.match(/phone/i)) {
    		return 'bot';
    	}  
